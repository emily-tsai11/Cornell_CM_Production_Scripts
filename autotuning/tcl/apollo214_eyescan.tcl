...
set nfspath /afs/cern.ch/user/e/etsai/workspace/Cornell_CM_Production_Scripts/scans/apollo214/30-06-24
# Also, be sure to first create corresponding directories to save the scans to (e.g. scans/apollo214/30-06-24)
