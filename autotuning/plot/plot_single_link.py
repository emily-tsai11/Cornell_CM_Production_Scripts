...
parser.add_option('--ff', dest="ff", default='X0Y48',help='Link of the FF.')
...
#ff_12 = ["X0Y4","X0Y5","X0Y6","X0Y7","X0Y8","X0Y9","X0Y10","X0Y11","X0Y12","X0Y13","X0Y14","X0Y15"]
output_dir = "results_alpha2B_site3"
#_alpha2_A_1"
    ...
    for TxPost in TXPOSTs:
        ...
        for TxEq in TxEqs_12:
            ...
            for TxDiff in TXDIFFSWINGs:
                ...
                nlinks = 0
                file_ff = open("../"+output_dir+"/"+TxEq+"_Rx"+o.ff+"_Tx"+o.ff+"_ErrReq5000_BER1e-6_Bathtub.csv", 'r')
                while file_ff:
...
nlinks = np.array(Nlinks_noerrors_np)
...
fig.tight_layout()
plt.savefig('alpha2_part2_site3/ff_plot_alpha2_part2_'+o.ff+'.png')
plt.show()
