...
TxEqs_12 = ["defaultTxEq"]#, "TxEqBin1_", "TxEqBin2_"]
...
ff_12= ["X0Y31","X0Y30","X0Y29","X0Y28","X0Y27","X0Y26","X0Y25","X0Y24","X0Y23","X0Y22","X0Y21","X0Y20"]
    ...
    for TxPost in TXPOSTs:
        ...
        for TxEq in TxEqs_12:
            ...
            for TxDiff in TXDIFFSWINGs:
                ...
                nlinks = 0
                for ff in ff_12:
                    file_ff = open("../results_1/"+TxEq+"_Rx"+ff+"_Tx"+ff+"_ErrReq5000_BER1e-6_Bathtub.csv", 'r')
                    while file_ff:
