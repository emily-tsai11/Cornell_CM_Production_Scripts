% pdflatex --jobname=240719_6x12ch_2x4ch_fibersCleaned "\def\dateofscans{24-07-19-fibersCleaned} \input{eyescan_summary.tex}"
...
\newpage
  ...
  \begin{figure}[h] % ``[t!]'' placement specifier just for this example
    % Numbers here can be modified based on loopback links scanned
    \foreach \number [count=\nxtrow from int(1), count=\i from int(\thepage+2)] in {36,...,39} {
      \ifthenelse{\nxtrow=4 \OR \nxtrow=8 \OR \nxtrow=12 \OR \nxtrow=16 \OR \nxtrow=20 \OR \nxtrow=24 \OR \nxtrow=28}{
        \begin{subfigure}{0.25\textwidth}
          \hyperlink{page.\i}{\includegraphicsmaybe{../../scans/\board/\dateofscans/eyescan_X0Y\number(xcvu13p_0tx)_to_X0Y\number(xcvu13p_0rx).png}}
        \end{subfigure}
    ...
    \caption{F1\_6 overview.} % \label{F1_6_overview}
  \end{figure}

\chapter{Links between xcvu13p\_1 and xcvu13p\_1 overview}
\hyperlink{MyToc}{Return to Table of Contents}
\newpage
  ...
  \begin{figure}[h] % ``[t!]'' placement specifier just for this example
    ...
    \caption{F2\_6 overview.} % \label{F2_6_overview}
  \end{figure}

\chapter{Links between xcvu13p\_0 and xcvu13p\_1 overview}
\hyperlink{MyToc}{Return to Table of Contents}
\newpage
  ...
  \begin{figure}[h] % ``[t!]'' placement specifier just for this example
    ...
    \caption{F1\_1 Tx connected to F2\_2 Rx in reverse loopback overview.} % \label{F1_1_to_F2_2_reverse_loopback_overview}
  \end{figure}

\chapter{Links between xcvu13p\_1 and xcvu13p\_0 overview}
\hyperlink{MyToc}{Return to Table of Contents}
\newpage
  ...
  \begin{figure}[h] % ``[t!]'' placement specifier just for this example
    ...
    \caption{F2\_2 Tx connected to F1\_1 Rx in reverse loopback overview.} % \label{F2_2_to_F1_1_reverse_loopback_overview}
  \end{figure}

\chapter{Links between xcvu13p\_0 and xcvu13p\_0 details}
\hyperlink{MyToc}{Return to Table of Contents}
\newpage
