% pdflatex --jobname=240806_6x12ch_2x4ch "\def\dateofscans{24-08-06} \input{eyescan_summary.tex}"
...
% REAL START OF PDF
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Links between xcvu13p\_0 and xcvu13p\_0}
\hyperlink{MyToc}{Return to Table of Contents}
\newpage

  \begin{figure}[h]
    \foreach \number [count=\nxtrow from int(1), count=\i from int(\thepage+1), evaluate=\number as \Rx using int(19-\number)] in {4,...,15}{
      \ifthenelse{\nxtrow=4 \OR \nxtrow=8 \OR \nxtrow=12 \OR \nxtrow=16 \OR \nxtrow=20 \OR \nxtrow=24 \OR \nxtrow=28}{
    ...
    \caption{F1\_1 reverse loopback overview.}
  \end{figure}
  % Details
  \foreach \n [evaluate=\n as \Rx using int(19-\n)] in {4,...,15}{
  ...
  \begin{figure}[h]
    \foreach \number [count=\nxtrow from int(1), count=\i from int(\thepage+1)] in {20,...,31} {
      \ifthenelse{\nxtrow=4 \OR \nxtrow=8 \OR \nxtrow=12 \OR \nxtrow=16 \OR \nxtrow=20 \OR \nxtrow=24 \OR \nxtrow=28}{
        \begin{subfigure}{0.25\textwidth}
    ...
    \caption{F1\_2 loopback overview.}
  \end{figure}
  % Details
  \foreach \n in {20,...,31} {
  ...
  \begin{figure}[h]
    ...
    \caption{F1\_3 reverse loopback overview.}
  \end{figure}
  % Details
  \foreach \n [evaluate=\n as \Rx using int(107-\n)] in {48,...,59}{
    \modifiedincludepdf{-}{X0Y\n(xcvu13p_0tx)_to_X0Y\Rx(xcvu13p_0rx)}{../../scans/\board/\dateofscans/eyescan_X0Y\n(xcvu13p_0tx)_to_X0Y\Rx(xcvu13p_0rx).pdf}
  ...
  \begin{figure}[h]
    \foreach \number [count=\nxtrow from int(1), count=\i from int(\thepage+1)] in {36,...,39} {
      \ifthenelse{\nxtrow=4 \OR \nxtrow=8 \OR \nxtrow=12 \OR \nxtrow=16 \OR \nxtrow=20 \OR \nxtrow=24 \OR \nxtrow=28}{
        \begin{subfigure}{0.25\textwidth}
          \hyperlink{page.\i}{\includegraphicsmaybe{../../scans/\board/\dateofscans/eyescan_X0Y\number(xcvu13p_0tx)_to_X0Y\number(xcvu13p_0rx).png}}
        \end{subfigure}
...
\chapter{Links between xcvu13p\_1 and xcvu13p\_1}
\hyperlink{MyToc}{Return to Table of Contents}
\newpage

  \begin{figure}[h]
    \foreach \number [count=\nxtrow from int(1), count=\i from int(\thepage+1)] in {4,...,15} {
      \ifthenelse{\nxtrow=4 \OR \nxtrow=8 \OR \nxtrow=12 \OR \nxtrow=16 \OR \nxtrow=20 \OR \nxtrow=24 \OR \nxtrow=28}{
        \begin{subfigure}{0.25\textwidth}
    ...
    \caption{F2\_1 loopback overview.}
  \end{figure}
  % Details
  \foreach \n in {4,...,15} {
  ...
  \begin{figure}[h]
    ...
    \caption{F2\_2 reverse loopback overview.}
  \end{figure}
  % Details
  \foreach \n [evaluate=\n as \Rx using int(51-\n)] in {20,...,31}{
  ...
  \begin{figure}[h]
    ...
    \caption{F2\_3 reverse loopback overview.}
  \end{figure}
  % Details
  \foreach \n [evaluate=\n as \Rx using int(107-\n)] in {48,...,59}{
    \modifiedincludepdf{-}{X0Y\n(xcvu13p_1tx)_to_X0Y\Rx(xcvu13p_1rx)}{../../scans/\board/\dateofscans/eyescan_X0Y\n(xcvu13p_1tx)_to_X0Y\Rx(xcvu13p_1rx).pdf}
...
% \chapter{Links between xcvu13p\_0 and xcvu13p\_1}
% \hyperlink{MyToc}{Return to Table of Contents}
% \newpage

%   \begin{figure}[h]
%     \foreach \number [count=\nxtrow from int(1), count=\i from int(\thepage+1), evaluate=\number as \Rx using int(35-\number)] in {4,...,15}{
%       \ifthenelse{\nxtrow=4 \OR \nxtrow=8 \OR \nxtrow=12 \OR \nxtrow=16 \OR \nxtrow=20 \OR \nxtrow=24 \OR \nxtrow=28}{
%         \begin{subfigure}{0.25\textwidth}
%           \hyperlink{page.\i}{\includegraphicsmaybe{../../scans/\board/\dateofscans/eyescan_X0Y\number(xcvu13p_0tx)_to_X0Y\Rx(xcvu13p_1rx).png}}
%         \end{subfigure}
%       }{
%         \begin{subfigure}{0.25\textwidth}
%           \hyperlink{page.\i}{\includegraphicsmaybe{../../scans/\board/\dateofscans/eyescan_X0Y\number(xcvu13p_0tx)_to_X0Y\Rx(xcvu13p_1rx).png}}
...
%       }
%     }
%     \caption{F1\_1 Tx connected to F2\_2 Rx in reverse loopback overview.}
%   \end{figure}
%   % Details
%   \foreach \n [evaluate=\n as \Rx using int(35-\n)] in {4,...,15}{
...
% \chapter{Links between xcvu13p\_1 and xcvu13p\_0}
% \hyperlink{MyToc}{Return to Table of Contents}
% \newpage
...
%       \ifthenelse{\nxtrow=4 \OR \nxtrow=8 \OR \nxtrow=12 \OR \nxtrow=16 \OR \nxtrow=20 \OR \nxtrow=24 \OR \nxtrow=28}{
%         \begin{subfigure}{0.25\textwidth}
%           \hyperlink{page.\i}{\includegraphicsmaybe{../../scans/\board/\dateofscans/eyescan_X0Y\number(xcvu13p_1tx)_to_X0Y\Rx(xcvu13p_0rx).png}}
%         \end{subfigure}
%       }{
%         \begin{subfigure}{0.25\textwidth}
%           \hyperlink{page.\i}{\includegraphicsmaybe{../../scans/\board/\dateofscans/eyescan_X0Y\number(xcvu13p_1tx)_to_X0Y\Rx(xcvu13p_0rx).png}}
...
%       }
%     }
%     \caption{F2\_2 Tx connected to F1\_1 Rx in reverse loopback overview.}
%   \end{figure}
%   % Details
%   \foreach \n [evaluate=\n as \Rx using int(35-\n)] in {20,...,31}{
